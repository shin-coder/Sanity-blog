...
export default function LinkText({ text }: TextProps) {
  return (
    <>
      <div className="flex flex-col whitespace-nowrap relative overflow-hidden">
        <p className="text-xs flex gap-1 leading-none group-hover:-translate-y-full transition-transform duration-300">
          (<span>{text}</span>)
        </p>
